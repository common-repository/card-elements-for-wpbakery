...
<div class="profile-card-style-3 <?php echo esc_attr('profile_card_class_'. esc_attr($custom_uniq_class)); ?>" style="background-image:url(<?php echo esc_url($cewb_profile_background_image); ?>);">
...
<style>
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-3 .profile-description-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-3 .profile-social-icon-color-dynamic-style{
