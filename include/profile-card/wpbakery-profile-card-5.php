    ...
    <div id="ct-team-member-2" class="ct-team-member-layout">
        <div class="ct-team-member-inner profile-background-dynamic-style">
            ...
            <div class="ct-team-holder">
                <h3 class="ct-team-title profile-name profile-name-dynamic-style" style="font-family: <?php echo esc_attr($google_fonts_family_for_name[0]); ?>;font-weight: <?php echo esc_attr($google_fonts_styles_for_name[1]); ?>;  font-style: <?php echo esc_attr($google_fonts_styles_for_name[2]); ?>;"><?php  echo esc_html($cewb_profile_name ); ?></h3>
                <div class="ct-team-position profile-position profile-position-dynamic-style" style="font-family: <?php echo esc_attr($google_fonts_family_for_pos[0]); ?>;font-weight: <?php echo esc_attr($google_fonts_styles_for_pos[1]); ?>; font-style: <?php echo esc_attr($google_fonts_styles_for_pos[2]); ?>;">
                    <?php echo esc_html($cewb_profile_position); ?>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-social-icon-background-dynamic-style:hover{
