...
<div class="profile-card-style-4 text-center <?php echo 'profile_card_class_'.esc_attr($custom_uniq_class);?> " style="background-image:url(<?php echo esc_url($cewb_profile_background_image); ?>);">
    ...
    <div class="profile-content profile-background-dynamic-style ">
        ...
        <div class="profile-name profile-name-dynamic-style " style=" font-family: <?php echo esc_attr($google_fonts_family_for_name[0]); ?>;font-weight: <?php echo esc_attr($google_fonts_styles_for_name[1]); ?>;  font-style: <?php echo esc_attr($google_fonts_styles_for_name[2]); ?>;"><?php  echo esc_html($cewb_profile_name); ?>
